...
```{r, eval=FALSE, include=FALSE}
## now get average values, for cells where rounding to 4 decimal places did not create the exact same values
## average over the same rns
## but for now cheat and drop to 3
