...
## Yvonne's ordering
ModelDF$Predominant_habitat <- factor(ModelDF$Predominant_habitat, 
                      levels = c("Primary vegetation", "unknown Secondary",  "Mature secondary", 
                                 "Intermediate secondary", "Young secondary",
                                 "Plantation forest", "Pasture", "Cropland", "Urban"))
```
...
sum.df %>% 
  kable(booktabs = T, caption = "Table 3. Occurrence model output") %>%
...
sum.df %>% 
  kable(booktabs = T, caption = "Table 4. Abundance model outputt") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) %>%
...
sum.df %>% 
  kable(booktabs = T, caption = "Table 5a. Effect size for Life form Occurrence by Land use") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) 
```
...
sum.df %>% 
  kable(booktabs = T, caption = "Table 5b. Effect size for Life form Occurrence by Climate") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) 
```
...
sum.df <- as_tibble(g)
sum.df %>% 
  kable(booktabs = T, caption = "Table 5c. Range in Effect sizes for Life form Occurrence across Land use") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) 
```
...
sum.df %>% 
  kable(booktabs = T, caption = "Table 6a. Effect size for Life form Abundance by Land use") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) 
```
...
sum.df %>% 
  kable(booktabs = T, caption = "Table 6b. Effect size for Life form Abundance by Climate") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) 
```
...
sum.df <- as_tibble(g)
sum.df %>% 
  kable(booktabs = T, caption = "Table 6c. Range in Effect sizes for Life form Abundance across Land use") %>%
  kable_styling(bootstrap_options = "striped", full_width = T) 
```
...
sum.df %>% 
  kable(booktabs = T, caption = "Table 7. Summary statistics for climatic variables") %>%
...
sum.df %>% 
  kable(booktabs = T, caption = "Table 8. Biome averages for climatic variables") %>%
  kable_styling(bootstrap_options = "striped", full_width = F) 
```
