...
lu_oc1 <- lu_oc + theme(axis.text.x = element_blank(), axis.title.x = element_blank(),
  ...
  ylim(-1.105, 1.105) ## unadjusted estimates
  #ylim(x,x) ## estiamtes - intercept (so they are zero centered for interprrtation)
...
clim_oc1 <- clim_oc + theme(axis.text.x = element_blank(), axis.title.x = element_blank(),
                         axis.ticks.x = element_blank(), axis.title.y = element_blank(),   legend.key = element_rect(colour = NA, fill = NA)) + ylim(-1.5, 0.2) 
