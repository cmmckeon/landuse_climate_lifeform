...
*Supplementary Information for “Land use and climate affect plant occurrence and abundance across life forms”*

## Appendix S1 – Table of data sources 


## Appendix S2 – Map of data origins 
...
## Appendix S4 – Data validation extended methods 

## Appendix S5 – Biome and Ecoregion visual summaries
...
```{r}
data <- readRDS("sd_model_clim_data.rds")
biome_diff <- readRDS("average_biome_diffs.rds")
eco_diff <- readRDS("average_ecoregion_diffs.rds")
...
## Appendix S6 – Effect size visual explanation

## Appendix S7 – Extended references list
