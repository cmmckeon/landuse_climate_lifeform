...
## the three weighted effects coding models for the occurrence data, created in LF_12_merged_LU_frequentist_occurrence.R
# oc_wec_merged_no_P_C.rds
# oc_wec_merged_no_PV_P.rds
# oc_wec_merged_no_U_T.rds
...
```{r}
## read in models
f_mod_a <- readRDS("oc_wec_merged_no_P_C.rds")
f_mod_b <- readRDS("oc_wec_merged_no_PV_P.rds")
f_mod_c <- readRDS("oc_wec_merged_no_U_T.rds")

## make models readable
f_mod_a <- up2date(f_mod_a) 
f_mod_b <- up2date(f_mod_b) 
f_mod_c <- up2date(f_mod_c) 
```
...
f_oc_sum_a$eff_sz[2:13] <- f_oc_sum_a$eff_sz[2:13]+f_oc_sum_a$Estimate[1]
f_oc_sum_a$eff_sz[14:21] <- f_oc_sum_a$eff_sz[14:21]+f_oc_sum_a$eff_sz[10]+f_oc_sum_a$Estimate[2:9]
f_oc_sum_a$eff_sz[22:29] <- f_oc_sum_a$eff_sz[22:29]+f_oc_sum_a$eff_sz[11]+f_oc_sum_a$Estimate[2:9]
f_oc_sum_a$eff_sz[30:37] <- f_oc_sum_a$eff_sz[30:37]+f_oc_sum_a$eff_sz[12]+f_oc_sum_a$Estimate[2:9]
f_oc_sum_a$eff_sz[38:45] <- f_oc_sum_a$eff_sz[38:45]+f_oc_sum_a$eff_sz[13]+f_oc_sum_a$Estimate[2:9]
f_oc_sum_a$eff_sz[51:54] <- f_oc_sum_a$eff_sz[51:54]+f_oc_sum_a$eff_sz[46]
f_oc_sum_a$eff_sz[55:58] <- f_oc_sum_a$eff_sz[55:58]+f_oc_sum_a$eff_sz[47]
f_oc_sum_a$eff_sz[59:62] <- f_oc_sum_a$eff_sz[59:62]+f_oc_sum_a$eff_sz[48]
f_oc_sum_a$eff_sz[63:66] <- f_oc_sum_a$eff_sz[63:66]+f_oc_sum_a$eff_sz[49]
f_oc_sum_a$eff_sz[67:70] <- f_oc_sum_a$eff_sz[67:70]+f_oc_sum_a$eff_sz[50]
...
f_oc_sum_b$eff_sz[2:13] <- f_oc_sum_b$eff_sz[2:13]+f_oc_sum_b$Estimate[1]
f_oc_sum_b$eff_sz[14:21] <- f_oc_sum_b$eff_sz[14:21]+f_oc_sum_b$eff_sz[10]+f_oc_sum_b$Estimate[2:9]
f_oc_sum_b$eff_sz[22:29] <- f_oc_sum_b$eff_sz[22:29]+f_oc_sum_b$eff_sz[11]+f_oc_sum_b$Estimate[2:9]
f_oc_sum_b$eff_sz[30:37] <- f_oc_sum_b$eff_sz[30:37]+f_oc_sum_b$eff_sz[12]+f_oc_sum_b$Estimate[2:9]
f_oc_sum_b$eff_sz[38:45] <- f_oc_sum_b$eff_sz[38:45]+f_oc_sum_b$eff_sz[13]+f_oc_sum_b$Estimate[2:9]
f_oc_sum_b$eff_sz[51:54] <- f_oc_sum_b$eff_sz[51:54]+f_oc_sum_b$eff_sz[46]
f_oc_sum_b$eff_sz[55:58] <- f_oc_sum_b$eff_sz[55:58]+f_oc_sum_b$eff_sz[47]
f_oc_sum_b$eff_sz[59:62] <- f_oc_sum_b$eff_sz[59:62]+f_oc_sum_b$eff_sz[48]
f_oc_sum_b$eff_sz[63:66] <- f_oc_sum_b$eff_sz[63:66]+f_oc_sum_b$eff_sz[49]
f_oc_sum_b$eff_sz[67:70] <- f_oc_sum_b$eff_sz[67:70]+f_oc_sum_b$eff_sz[50]
...
f_oc_sum_c$eff_sz[2:13] <- f_oc_sum_c$eff_sz[2:13]+f_oc_sum_c$Estimate[1]
f_oc_sum_c$eff_sz[14:21] <- f_oc_sum_c$eff_sz[14:21]+f_oc_sum_c$eff_sz[10]+f_oc_sum_c$Estimate[2:9]
f_oc_sum_c$eff_sz[22:29] <- f_oc_sum_c$eff_sz[22:29]+f_oc_sum_c$eff_sz[11]+f_oc_sum_c$Estimate[2:9]
f_oc_sum_c$eff_sz[30:37] <- f_oc_sum_c$eff_sz[30:37]+f_oc_sum_c$eff_sz[12]+f_oc_sum_c$Estimate[2:9]
f_oc_sum_c$eff_sz[38:45] <- f_oc_sum_c$eff_sz[38:45]+f_oc_sum_c$eff_sz[13]+f_oc_sum_c$Estimate[2:9]
f_oc_sum_c$eff_sz[51:54] <- f_oc_sum_c$eff_sz[51:54]+f_oc_sum_c$eff_sz[46]
f_oc_sum_c$eff_sz[55:58] <- f_oc_sum_c$eff_sz[55:58]+f_oc_sum_c$eff_sz[47]
f_oc_sum_c$eff_sz[59:62] <- f_oc_sum_c$eff_sz[59:62]+f_oc_sum_c$eff_sz[48]
f_oc_sum_c$eff_sz[63:66] <- f_oc_sum_c$eff_sz[63:66]+f_oc_sum_c$eff_sz[49]
f_oc_sum_c$eff_sz[67:70] <- f_oc_sum_c$eff_sz[67:70]+f_oc_sum_c$eff_sz[50]
...
#saveRDS(f_oc_sum, "f_oc_sum_merged.rds")
```
