#' ---
#' title: "LF_12_merged_LU_frequentist_percent_cover.R"
...
pc_merged_no_U_T <- lmer(response ~ Predominant_habitat.wec + raunk_lf.wec + hab_raunk_interaction +
                                                        Species_richness +
                                                        map +
                                                        map_var +
                                                        mat +
...
if(exists("pc_merged_no_U_T")) {
  try(saveRDS(pc_merged_no_U_T, "pc_merged_no_U_T.rds"))
} else warning("pc_merged_no_U_T failed to run")
...
pc_merged_no_PV_P <- lmer(response ~ Predominant_habitat.wec + raunk_lf.wec + hab_raunk_interaction +
                                                         Species_richness +
                                                         map +
                                                         map_var +
                                                         mat +
...
if(exists("pc_merged_no_PV_P")) {
  try(saveRDS(pc_merged_no_PV_P, "pc_merged_no_PV_P.rds"))
} else warning("pc_merged_no_PV_P failed to run")
...
pc_merged_no_P_C <- lmer(response ~ Predominant_habitat.wec + raunk_lf.wec + hab_raunk_interaction +
                                                        Species_richness +
                                                        map +
                                                        map_var +
                                                        mat +
...
if(exists("pc_merged_no_P_C")) {
  try(saveRDS(pc_merged_no_P_C, "pc_merged_no_P_C.rds"))
} else warning("pc_merged_no_P_C failed to run")
