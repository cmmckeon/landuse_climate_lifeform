...
f_mod_a <- readRDS("f_oc_wec_int_maximal_zi_1_nested_no_P_C.rds")
...
f_mod_b <- readRDS("f_oc_wec_int_maximal_zi_1_nested_no_PF_P.rds")
...
f_mod_c <- readRDS("f_oc_wec_int_maximal_zi_1_nested_no_U_T.rds")
...
f_oc_sum$`z value` <- round(f_oc_sum$`z value`, 1)
