...
# Table 1. Occurrence model output
```{r}
...
# Table 2. Abundance model output
```{r}
...
# Table 3a. Effect size for Life form Occurrence by Land use
```{r}
...
# Table 3b. Effect size for Life form Occurrence by Climate
```{r}
...
## Table 3c. Range within effect sizes
```{r}
...
# Table 4a. Magnitude of Effect size for Life form Abundance by Land use
```{r}
...
# Table 4b. Magnitude of Effect size for Life form Abundance by Climate
```{r}
...
## Table 4c. Range within effect sizes
```{r}
...
# Table 5. Summary statistics for climatic variables
```{r}
all_clim_ave <- readRDS("all_clim_ave.rds")
...
# Table 6. Biome averages for climatic variables
```{r}
...
# Table 7a. Occurrence no species richness model output
```{r}
# tables of model outputs
...
# Table 7b. Abundance no species richness model output
```{r}
sum.df <- as_tibble(f_pc_sum[,c(16,2:4)])
