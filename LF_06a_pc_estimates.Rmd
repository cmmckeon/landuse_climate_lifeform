...
f_pc_sum$Estimate[f_pc_sum$rn == "(Intercept)"] <- mean(f_pc_sum$Estimate[f_pc_sum$rn == "(Intercept)"])
f_pc_sum$eff_sz[f_pc_sum$rn == "(Intercept)"] <- mean(f_pc_sum$eff_sz[f_pc_sum$rn == "(Intercept)"])

f_pc_sum$eff_sz[f_pc_sum$rn == "hab_raunk_interactionx1Young secondary vegetation:x2chamaephyte"] <- mean(
  f_pc_sum$eff_sz[f_pc_sum$rn == "hab_raunk_interactionx1Young secondary vegetation:x2chamaephyte"])

f_pc_sum$`t value`[f_pc_sum$rn == "map_raunk_interactioninteractphanerophyte"] <- mean(
  f_pc_sum$`t value`[f_pc_sum$rn == "map_raunk_interactioninteractphanerophyte"])

f_pc_sum$`t value`[f_pc_sum$rn == "mat_var"] <- mean(
  f_pc_sum$`t value`[f_pc_sum$rn == "mat_var"])

f_pc_sum$`t value`[f_pc_sum$rn == "Predominant_habitat.wecPrimary forest"] <- mean(
  f_pc_sum$`t value`[f_pc_sum$rn == "Predominant_habitat.wecPrimary forest"])

f_pc_sum$`t value`[f_pc_sum$rn == "Predominant_habitat.wecUrban"] <- mean(
  f_pc_sum$`t value`[f_pc_sum$rn == "Predominant_habitat.wecUrban"])

f_pc_sum$`t value`[f_pc_sum$rn == "raunk_lf.wecphanerophyte"] <- mean(
  f_pc_sum$`t value`[f_pc_sum$rn == "raunk_lf.wecphanerophyte"])
